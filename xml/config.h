...
enum UNITESELECTSTATUS{no_select, in_select, select_end};
enum SHOWTYPE{no_show, lefttoringt_show, showtype_end};
enum TEXTFONT{font_song, font_hei, textfont_end};
enum TEXTSIZE{font_10, font_12, font_14, font_16, font_18, font_20, font_22, font_24, font_26, font_28, font_30, textsize_end};
enum TEXTWEIGHTS{font_normal, font_bold, textweights_end};
enum TEXTCOLOR{font_black, font_white, font_red, font_blue, font_green, font_purple, textcolor_end};
enum TEXTHEIGHT{font_h_1, font_h_2, font_h_4, font_h_6, font_h_8, font_h_10, font_h_12, font_h_14, font_h_16, font_h_18, font_h_20, font_h_22, font_h_24, font_h_26, font_h_28, font_h_30, font_h_end};
