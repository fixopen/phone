...
namespace Logical
{
    ...
    public:
        ...
        static UINT32 CalcDateDiff(UINT16 iEndYear, UINT16 iEndMonth, UINT16 iEndDay, UINT16 iStartYear = START_YEAR, UINT16 iStartMonth = 1, UINT16 iStartDay = 1);


        //计算公历iYear年iMonth月iDay日对应的阴历日期,返回对应的阴历节气 0-24
        //1901年1月1日---2050年12月31日
        static UINT16 GetLunarDate(UINT16 iYear, UINT16 iMonth, UINT16 iDay, UINT16& iLunarYear, UINT16& iLunarMonth, UINT16& iLunarDay);

        //计算从1901年1月1日过iSpanDays天后的阴历日期
        //如果计算结果对应的月是闰月，且是闰月的第二个月则返回1， 否则返回0
        static UINT8 CalcLunarDate(UINT16& iLunarYear, UINT16& iLunarMonth, UINT16& iLuanrDay, UINT32 iSpanDays);
