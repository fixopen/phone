...
#define SABTD_CEDLL_API extern "C" __declspec(dllexport)
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_Init(void** ppSabtdStatus, int sampleRate, char* license);
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_UnInit(void* pSabtdStatus);
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_SetParam(void* pSabtdStatus, ParamType paramType, float paramValue);
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_GetParam(void* pSabtdStatus, ParamType paramType, float* pParamValue);
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_Reset(void* pSabtdStatus);
...
//       负值            见SAVE返回代码
//////////////////////////////////////////////////////////////////////////
SABTD_CEDLL_API int SABTD_Process(void* pSabtdStatus, int* result, short* data, int length);
