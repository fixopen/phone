    ...
    namespace Data {
        ...
        public:
            ...
            std::wstring const name() const {
                ...
                //if (!contactFinded_) {
                //    contactFinded_ = true;
                std::vector<Util::shared_ptr<Contact::Data::Contact> > t = Contact::Data::Contact::Select(L"id = " + Util::StringOp::FromInt(contactId_));
                if (t.size() == 1) {
                    result = t[0]->name();
                }
                //}
            ...
            std::vector<Util::shared_ptr<Contact::Data::SoundSegment> > const sounds() const;
            void appendSound(Util::shared_ptr<Contact::Data::SoundSegment>& soundSegment);
        public:
            CallInfo(); //create
            //~CallInfo(); //destroy
            ...
            Util::shared_ptr<Contact::Data::SoundSegment> const Record();
            void StopRecord();
        private:
        ...
        private:
            ...
            mutable std::vector<Util::shared_ptr<Contact::Data::SoundSegment> > sounds_;
            bool isInserted_;
        };
    }
}
