...
namespace Contact {
    namespace Data {
        ...
        public:
            ...
            std::vector<Util::shared_ptr<Telephone::Data::CallInfo> > const histories() const;
        public:
            Contact(); //create
            //~Contact(); //destroy
        ...
        private:
            ...
            //post
            std::wstring company_; //@@rename to state
            std::wstring department_; //@@rename to postCode
            std::wstring duty_;
            std::wstring address_; //@@rename to street
            std::wstring postCode_;
            //internet
            std::wstring email_;
            std::wstring qq_;
            std::wstring msn_;
            std::wstring faceback_;
            std::wstring twitter_;
            ...
            std::wstring wave_;
            //other
            std::wstring remarks_;
            //history
            mutable bool historiesFinded_;
            mutable std::vector<Util::shared_ptr<Telephone::Data::CallInfo> > histories_;
        };
    }
}
