...
namespace Contact {
    namespace Data {
        ...
        void SoundSegment::Update() const {
            ...
            cmd += L"', [contactInfoId] = ";
            cmd += Util::StringOp::FromInt(callInfoId_);
            cmd += L", [isPlayed] = ";
        ...
        void SoundSegment::Play() {
            switch (type_) {
                ...
                case sstLocalRecord:
                    ...
                    //tcpmp player
                    Util::WavePlayer::Instance()->SetStopNotify(StopNotify);
                    Util::WavePlayer::Instance()->Start(filename());
                    break;
                case sstRingtone:
                    Util::RingtonePlayer::Instance()->SetStopNotify(StopNotify);
                    Util::RingtonePlayer::Instance()->Start(Util::StoragePath::GetFlashDrvPath() + L"/" + ringtoneFolderName_ + L"/" + filename_);
                    break;
                case sstPrompt:
                    Util::RingtonePlayer::Instance()->SetStopNotify(StopNotify);
                    Util::RingtonePlayer::Instance()->Start(Util::StoragePath::GetFlashDrvPath() + L"/" + promptFolderName_ + L"/" + filename_, 1);
                    break;
                default:
                    break;
            }
        ...
        void SoundSegment::PausePlay() {
            switch (type_) {
                ...
                case sstRingtone:
                case sstPrompt:
                    Util::RingtonePlayer::Instance()->Pause();
                    break;
                default:
                    break;
            }
        ...
        void SoundSegment::ResumePlay() {
            switch (type_) {
                ...
                case sstRingtone:
                case sstPrompt:
                    Util::RingtonePlayer::Instance()->Resume();
                    break;
                default:
                    break;
            }
        ...
        void SoundSegment::BreakPlay() {
            switch (type_) {
                ...
                case sstRingtone:
                case sstPrompt:
                    Util::RingtonePlayer::Instance()->Stop();
                    break;
                default:
                    break;
            }
        ...
        void SoundSegment::modifyFieldByDB_(int argc, char** argv, char** columnName, Util::shared_ptr<SoundSegment>& item) {
            ...
            item->callInfoId_ = Util::StringOp::ToInt(argv[GetIndexByName(argc, columnName, "contactInfoId")]);
