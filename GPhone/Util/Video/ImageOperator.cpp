...
namespace Util {
    namespace Video {
        void ImageOp::DrawImage(HDC destination, RECT destPosition, std::wstring sourceFilename, RECT sourcePosition) {
        ...
        void ImageOp::DrawImage(HDC destination, RECT destPosition, std::wstring sourceFilename) {
            DWORD typeId = CxImage::GetTypeIdFromName(findExtension_(sourceFilename.c_str()));
            CxImage img;
            img.Load(sourceFilename.c_str(), typeId);
            //img.Blt(destination, destPosition.x, destPosition.y);
        ...
        void ImageOp::DrawImage(HDC destination, std::wstring sourceFilename, RECT sourcePosition) {
            DWORD typeId = CxImage::GetTypeIdFromName(findExtension_(sourceFilename.c_str()));
            CxImage img;
            img.Load(sourceFilename.c_str(), typeId);
            img.Crop(sourcePosition);
        ...
        void ImageOp::DrawImage(HDC destination, std::wstring sourceFilename) {
            DWORD typeId = CxImage::GetTypeIdFromName(findExtension_(sourceFilename.c_str()));
            CxImage img;
            img.Load(sourceFilename.c_str(), typeId);
            img.Blt(destination);
        ...
        namespace {
            ...
            int findIndex_(std::wstring filename) {
                int result = -1;
            ...
            void AddToMemory_(std::wstring filename, HDC hDC) {
            ...
            void DrawImage(std::wstring filename, HDC hDC, RECT srcBounds, RECT dstBounds) {
#if 0
                CFile file;
