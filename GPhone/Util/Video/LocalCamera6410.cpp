                ...
                if (iSize == sizeof(VIDEO_STREAM_CONFIG_CAPS)) {
                    ...
                    for (int iFormat = 0; iFormat < iCount; ++iFormat) {
                        ...
                        if (SUCCEEDED(hr)) {
                            ...
                            if ((mtConfig->majortype == MEDIATYPE_Video) && (mtConfig->subtype == MEDIASUBTYPE_YV12) && (mtConfig->formattype == FORMAT_VideoInfo) && (mtConfig->cbFormat >= sizeof(VIDEOINFOHEADER)) && (mtConfig->pbFormat != 0)) {
                                ...
                                if (((lWidth == parameters_.width) || (lWidth == -parameters_.width)) && ((lHeight == parameters_.height) || ((lHeight == -parameters_.height)))) {
                                    static int isSet = 0;
                                    if (!isSet) {
