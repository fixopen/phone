...
namespace Util {
    ...
    bool RS232::Open(unsigned int portNo, unsigned int baud, unsigned int parity, unsigned int databits, unsigned int stopbits) {
        // 已经打开的话，直接返回
    ...
    bool RS232::Write(unsigned char const* const data, unsigned int length) {
        DWORD writedBytes;
