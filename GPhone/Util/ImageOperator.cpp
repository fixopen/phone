...
namespace Util {
    void ImageOp::DrawImage(HDC destination, RECT destPosition, CString sourceFilename, RECT sourcePosition)
    {
    ...
    void ImageOp::DrawImage(HDC destination, RECT destPosition, CString sourceFilename)
    {
        DWORD typeId = CxImage::GetTypeIdFromName(findExtension_((LPCTSTR)sourceFilename));
        CxImage img;
        img.Load((LPCTSTR)sourceFilename, typeId);
    ...
    void ImageOp::DrawImage(HDC destination, CString sourceFilename, RECT sourcePosition)
    {
        DWORD typeId = CxImage::GetTypeIdFromName(findExtension_((LPCTSTR)sourceFilename));
        CxImage img;
        img.Load((LPCTSTR)sourceFilename, typeId);
    ...
    void ImageOp::DrawImage(HDC destination, CString sourceFilename)
    {
        DWORD typeId = CxImage::GetTypeIdFromName(findExtension_((LPCTSTR)sourceFilename));
        CxImage img;
        img.Load((LPCTSTR)sourceFilename, typeId);
    ...
    TCHAR* ImageOp::findExtension_(TCHAR const* name)
    {
        int len = wcslen(name);
