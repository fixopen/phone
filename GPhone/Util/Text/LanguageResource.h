#ifndef __DATA_TEXT_LANGUAGERESOURCE_H__
#define __DATA_TEXT_LANGUAGERESOURCE_H__
...
namespace Util {
    namespace Text {
        ...
        public:
            ...
            static std::vector<Util::shared_ptr<LanguageResource> > GetFromDatabase(std::wstring const & filter, std::wstring const & orderFieldName = L"id", SeqenceRelation const dir = srNull, int const offset = 0, int const pageSize = -1); //get from database
...
#endif //__DATA_TEXT_LANGUAGERESOURCE_H__