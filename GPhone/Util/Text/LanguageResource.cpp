    ...
    namespace Text {
        std::vector<LangResource> langResource() {
            static const LangResource data[] = {
                ...
                LangResource(RI_SETTING_BACKUP, "备份"), LangResource(RI_SETTING_RESTORE, "恢复"), LangResource(RI_SETTING_IN, "导入"), LangResource(RI_SETTING_OUT, "导出"), LangResource(RI_SETTING_RING, "振铃音乐"), LangResource(RI_SETTING_PHOTO, "电子相册"), LangResource(RI_SETTING_MP3, "MP3音乐"), LangResource(RI_SETTING_VIDEO, "视频文件"), LangResource(RI_SETTING_RECORDE, "录音文件"), LangResource(RI_SETTING_LOCALFILE, "本地文件"), LangResource(RI_SETTING_USBFILE, "U盘文件"), LangResource(RI_SETTING_COPYFILE, "文件备份与恢复"), LangResource(RI_SETTING_COPYFILE_ERROR1, "移动存储设备不存在，请检查后重试!"), LangResource(RI_SETTING_COPYFILE_ERROR2, "此操作会覆盖已有的文件!"), LangResource(RI_SETTING_COPYFILE_ERROR3, "文件不存在!"), LangResource(RI_SETTING_COPYFILE_FINISH, "操作已完成!"), LangResource(RI_SETTING_COPYFILE_DOWITH, "正在拷贝文件,不要断电, 请稍后..."),
                ...
                LangResource(RI_PASSWORD_TITLE, "设置密码"), LangResource(RI_PASSWORD_TITLE1, "验证密码"), LangResource(RI_PASSWORD_TIP, "请输入密码:"), LangResource(RI_PASSWORD_TIP1, "密码验证错误, 请重新输入旧密码:"), LangResource(RI_PASSWORD_TIP2, "新密码输入不相符, 请重新输入新密码:"), LangResource(RI_PASSWORD_TIP3, "密码错误, 请重新输入:"), LangResource(RI_PASSWORD_OLDPASSWORD, "旧密码:"), LangResource(RI_PASSWORD_NEWPASSWORD1, "新密码:"), LangResource(RI_PASSWORD_NEWPASSWORD2, "确认新密码:"), LangResource(RI_DELETETIP_TITLE, "删除确认"), LangResource(RI_DELETETIP_TIP, "确定要删除该录音记录吗？"), LangResource(RI_DELETETIP_PASSWORD, "保护密码:"), LangResource(RI_DELETETIP_CONTACT, "确定要删除该名片吗？"), LangResource(RI_DELETETIP_CONTACTINFO, "确定要删除该通话记录吗？"), LangResource(RI_DELETETIP_CONTACTGROUP, "确定要删除该名片类别吗？(该类别名片一同被删除)"), LangResource(RI_DELETETIP_PASSWORD, "保护密码:"), LangResource(RI_DELETETIP_CONTACT2, "确定要永久清空名片吗？"), LangResource(RI_DELETETIP_CONTACTINFO2, "确定要永久清空通话记录吗？"), LangResource(RI_DELETETIP_SOUND2, "确定要永久清空录音记录吗？"),
