#ifndef __UTIL_CONTROL_IMAGEVIEWER_H__
#define __UTIL_CONTROL_IMAGEVIEWER_H__

#pragma once

#include <afxwin.h> //for CView, CDC
#include <atltypes.h> //for CPoint, CSize
#include <afx.h> //for CDumpContext
...
#endif //__UTIL_CONTROL_IMAGEVIEWER_H__
