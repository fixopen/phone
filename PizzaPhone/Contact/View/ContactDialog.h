#ifndef __CONTACT_VIEW_CONTACTDIALOG_H__
#define __CONTACT_VIEW_CONTACTDIALOG_H__
...
namespace Contact {
    namespace View {
        ...
        public:
            void SetContact(Util::shared_ptr<Contact::Data::Contact> const& contact);
            void SyncContact();
            ...
            Util::shared_ptr<Contact::Data::Contact> const GetContact() const;
...
#endif //__CONTACT_VIEW_CONTACTDIALOG_H__
