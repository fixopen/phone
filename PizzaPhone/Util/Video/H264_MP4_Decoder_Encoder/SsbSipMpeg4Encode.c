...
void* SsbSipMPEG4EncodeInit(int          strmType, unsigned int uiWidth, unsigned int uiHeight, unsigned int uiFramerate, unsigned int uiBitrate_kbps, unsigned int uiGOPNum) {
...
int SsbSipMPEG4EncodeExe(void* openHandle) {
    ...
    if (!pCTX->fInit) {
        ...
        r = DeviceIoControl(pCTX->hOpen, cmd, &mfc_args, sizeof(MFC_ENC_INIT_ARG), NULL, 0, NULL, NULL);
    ...
    /////////////////////////////////////////////////
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_MPEG4_ENC_EXE, &mfc_args, sizeof(MFC_ENC_EXE_ARG), NULL, 0, NULL, NULL);
