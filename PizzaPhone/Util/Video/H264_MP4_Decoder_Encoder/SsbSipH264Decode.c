...
int SsbSipH264DecodeExe(void* openHandle, long lengthBufFill) {
    ...
    if (!pCTX->fInit) {
        ...
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_H264_DEC_INIT, &mfc_args, sizeof(MFC_DEC_INIT_ARG), NULL, 0, NULL, NULL);
    ...
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_H264_DEC_EXE, &mfc_args, sizeof(MFC_DEC_EXE_ARG), NULL, 0, NULL, NULL);
