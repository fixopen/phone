...
void* SsbSipMPEG4DecodeInit() {
    ...
    /////     CreateFile     /////
    //////////////////////////////
    hOpen = CreateFile(L"MFC1:", GENERIC_READ | GENERIC_WRITE, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
...
int SsbSipMPEG4DecodeExe(void* openHandle, long lengthBufFill) {
    ...
    if (!pCTX->fInit) {
        ...
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_MPEG4_DEC_INIT, &mfc_args, sizeof(MFC_DEC_INIT_ARG), NULL, 0, NULL, NULL);
    ...
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_MPEG4_DEC_EXE, &mfc_args, sizeof(MFC_DEC_EXE_ARG), NULL, 0, NULL, NULL);
...
void* SsbSipMPEG4DecodeGetInBuf(void* openHandle, long size) {
    ...
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_LINE_BUF_ADDR, &mfc_args, sizeof(MFC_GET_BUF_ADDR_ARG), NULL, 0, NULL, NULL);
    if ((r == FALSE) || (mfc_args.get_buf_addr.ret_code != 0)) {
...
void* SsbSipMPEG4DecodeGetOutBuf(void* openHandle, long* size) {
    ...
    /////////////////////////////////////////////////
    mfc_args.get_buf_addr.in_usr_data = pCTX->proc_id;
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_FRAM_BUF_ADDR, &mfc_args, sizeof(MFC_GET_BUF_ADDR_ARG), NULL, 0, NULL, NULL);
    if ((r == FALSE) || (mfc_args.get_buf_addr.ret_code != 0)) {
...
int SsbSipMPEG4DecodeSetConfig(void* openHandle, MPEG4_DEC_CONF conf_type, void* value) {
    ...
    case MPEG4_DEC_SETCONF_POST_ROTATE:
        ...
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_SET_CONFIG, &mfc_args, sizeof(MFC_SET_CONFIG_ARG), NULL, 0, NULL, NULL);
...
int SsbSipMPEG4DecodeGetConfig(void* openHandle, MPEG4_DEC_CONF conf_type, void* value) {
    ...
    case MPEG4_DEC_GETCONF_PHYADDR_FRAM_BUF:
        ...
        /////////////////////////////////////////////////
        mfc_args.get_buf_addr.in_usr_data = pCTX->proc_id;
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_PHY_FRAM_BUF_ADDR, &mfc_args, sizeof(MFC_GET_BUF_ADDR_ARG), NULL, 0, NULL, NULL);
        if ((r == FALSE) || (mfc_args.get_buf_addr.ret_code != 0)) {
    ...
    case MPEG4_DEC_GETCONF_FRAM_NEED_COUNT:
        ...
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_GET_CONFIG, &mfc_args, sizeof(MFC_GET_CONFIG_ARG), NULL, 0, NULL, NULL);
