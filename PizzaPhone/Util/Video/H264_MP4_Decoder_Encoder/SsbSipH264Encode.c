...
int SsbSipH264EncodeExe(void* openHandle) {
    ...
    if (!pCTX->fInit) {
        ...
        ////////////////////////////////////////////////
        r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_H264_ENC_INIT, &mfc_args, sizeof(MFC_ENC_INIT_ARG), NULL, 0, NULL, NULL);
    ...
    /////////////////////////////////////////////////
    r = DeviceIoControl(pCTX->hOpen, IOCTL_MFC_H264_ENC_EXE, &mfc_args, sizeof(MFC_ENC_EXE_ARG), NULL, 0, NULL, NULL);
