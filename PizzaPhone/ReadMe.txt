================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PizzaPhone Project Overview
===============================================================================

The application wizard has created this PizzaPhone application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PizzaPhone application.
...
PizzaPhone.h
    ...
    project specific headers and declares the CPizzaPhoneApp application class.

PizzaPhone.cpp
    This is the main application source file that contains the application
    class CPizzaPhoneApp.
...
PizzaPhoneDlg.h, PizzaPhoneDlg.cpp - the dialog
    These files contain your CPizzaPhoneDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named PizzaPhone.pch and a precompiled types file named StdAfx.obj.
