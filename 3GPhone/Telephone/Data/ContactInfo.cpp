...
namespace Data {
    ...
    */
    ...
    std::vector<Util::shared_ptr<ContactInfo> > ContactInfo::Select(std::wstring const& filter, std::wstring const& orderFieldName, SeqenceRelation const dir, int const offset, int const pageSize) {
		return Util::DataAccess<ContactInfo>::GetDatasByFilter(filter, modifyFieldByDB_, orderFieldName, dir, offset, pageSize);
    }
    ...
    void ContactInfo::Remove() const {
        ContactInfo::Remove(L"id = " + Util::StringOp::FromInt(id()));
    }

    void ContactInfo::Remove(std::wstring filter) {
    ...
    void ContactInfo::modifyFieldByDB_(int argc, char** argv, char** columnName, Util::shared_ptr<ContactInfo> item) {
        ...
        item->type_ = static_cast<ContatcInfoType>(atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "type")]));
        item->isSound_ = !!atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "isSound")]);
		...
		item->telephoneNumber_ = Contact_::Data::TelephoneNumber(Util::StringOp::FromUTF8(argv[Util::BaseData::GetIndexByName(argc, columnName, "telephoneNumber")]), true);
    ...
    void ContactInfoSoundSegmentMap::Remove() const {
        ContactInfoSoundSegmentMap::Remove(L"id = " + Util::StringOp::FromInt(id()));
    }
    ...
    void ContactInfoSoundSegmentMap::modifyFieldByDB_(int argc, char** argv, char** columnName, Util::shared_ptr<ContactInfoSoundSegmentMap> item) {
		item->id(atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "id")]));
        item->soundSegmentId_ = atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "soundSegmentId")]);
    ...
    void ContactInfoPictureMap::Remove() const {
        ContactInfoPictureMap::Remove(L"id = " + Util::StringOp::FromInt(id()));
    }
    ...
    void ContactInfoPictureMap::modifyFieldByDB_(int argc, char** argv, char** columnName, Util::shared_ptr<ContactInfoPictureMap> item) {
		item->id(atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "id")]));
        item->pictureId_ = atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "soundSegmentId")]);
        item->contactInfoId_ = atoi(argv[Util::BaseData::GetIndexByName(argc, columnName, "contactId")]);
    }
}
}