#ifndef __CONTROL_SOFTKEY_H__
#define __CONTROL_SOFTKEY_H__
...
namespace Control {
    int const WRITE_LINE_BUFFMAX = 10;
    int const WRITE_LINE_POINTMAX = 1024 * 4;
    ...
    /////////////////////////////////////////////////////////////////////////////
    // CSoftKey window
    int const WM_SOFTKEY = (WM_USER+200);
    int const WM_SOFTKEY_REG = (WM_SOFTKEY+1);
    ...
    int const IMAGE_LEFT = 1;
    int const IMAGE_RIGHT = 2;
    int const IMAGE_TOP = 3;
    int const IMAGE_BOTTOM = 4;
    //用于状态任务栏，主界面中的应用程序
