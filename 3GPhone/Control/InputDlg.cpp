...
namespace Control {
    CRect const INPUTSOFTKEYRECT(0, 0, VOIPINPUT_FRMAE_WIDTH-1, VOIPINPUT_FRMAE_HEIGHT-1);
    CRect const INPUTSOFTKEYRECT1(0, 28, VOIPINPUT_FRMAE_WIDTH-1, VOIPINPUT_FRMAE_HEIGHT-1);

    int const VOIPINPUT_ENG_IDC = 0xFC02;
    int const VOIPINPUT_FUHAO_IDC = 0xFC03;
    int const VOIPINPUT_PINYIN_IDC = 0xFC04;
    int const VOIPINPUT_HAND_IDC = 0xFC05;

    int const VOIPINPUT_DELETE_VALUE = VK_BACK;		//0xFF00
    int const VOIPINPUT_COPY_VALUE = 0xFF01;
    int const VOIPINPUT_PASTE_VALUE = 0xFF02;
    int const VOIPINPUT_SPACE_VALUE = VK_SPACE;	//0xFF03
    int const VOIPINPUT_ENTER_VALUE = VK_RETURN;	//0xFF04
    int const VOIPINPUT_MOVE_VALUE = 0xFF03;
    int const VOIPINPUT_HIDE_VALUE = 0xFF05;
    int const VOIPINPUT_WRITE_VALUE = 0xFF06;
    int const VOIPINPUT_PINYIN_VALUE = 0xFF07;
    int const VOIPINPUT_ENG_VALUE = 0xFF08;
    int const VOIPINPUT_ZIFU_VALUE = 0xFF09;
    int const VOIPINPUT_COPSLOCK_VALUE = 0xFF0A;
    int const HOUXUAN_LOCAL = 0xFF0B;
    int const ARROW_LEFT = (HOUXUAN_LOCAL+6);
    int const ARROW_RIGHT = (ARROW_LEFT+1);

    int const HAND_REG1_VALUE = 0xFD00;
    int const HAND_REG2_VALUE = 0xFD01;
    int const HAND_REG3_VALUE = 0xFD02;
    int const HAND_REG4_VALUE = 0xFD03;
    int const HAND_REG5_VALUE = 0xFD04;
    int const HAND_REG6_VALUE = 0xFD05;
    int const HAND_REG7_VALUE = 0xFD06;
    int const HAND_REG8_VALUE = 0xFD07;
    int const HAND_REG9_VALUE = 0xFD08;
    int const HAND_REG10_VALUE = 0xFD09;

    int const HAND_TYPEHZ_VALUE = 0xFD0A;
    int const HAND_TYPEZM_VALUE = 0xFD0B;
    int const HAND_TYPESZ_VALUE = 0xFD0C;
...
#define	PINYIN_ADDRESS		g_pPinYin
    ...
    void CInputDlg::CreateCtrl()
    {
        ...
        //if (!(m_oSoftkeyP.Create(g_inputPinyinBMPID[g_skinstyle], thePoint, 62, r2, vSoftKeyP, INPUTSOFTKEYRECT, this, 0, VOIPINPUT_PINYIN_IDC)))
        //    return;
    ...
    void CInputDlg::l_SetInputWindow()
    {
        ...
        //        m_oSoftkeyEng.SetParameters(g_inputEng1BMPID[g_skinstyle]);
        //    else if (m_iUpOrLowCase == INPUTMATH_X)
        //        m_oSoftkeyEng.SetParameters(g_inputEngBMPID[g_skinstyle]);
