#ifndef __CONTROL_CESCROLLBAR__H__
#define __CONTROL_CESCROLLBAR__H__

namespace Control {
    /////////////////////////////////////////////////////////////////////////////
    // CCEScrollBar_ window
    int const SCROLL_ARROW_WIDTH = 34;		//	66			// 17
    int const SCROLL_ARROW_HEIGHT = 34;		//	43
    int const SCROLL_THICK_WIDTH = 34;		//	66
    int const SCROLL_THICK_HEIGHT = 34;		//	63
...
#endif //__CONTROL_CESCROLLBAR__H__
