...
namespace Control {
    // Return values
    int const BTNST_OK = 0;
    int const BTNST_INVALIDRESOURCE = 1;
    int const BTNST_FAILEDMASK = 2;
    int const BTNST_INVALIDINDEX = 3;
    int const BTNST_INVALIDALIGN = 4;
...
#pragma pack()
    ...
    /////////////////////////////////////////////////////////////////////////////
    // CCEBmpButton window
    int const UM_BTN_DOWN = (WM_USER + 10);
    int const UM_BTN_UP = (UM_BTN_DOWN + 1);
    ...
    public:
        ...
        BOOL Create(LPCTSTR lpszCaption, int nIDUp, int nIDDown, DWORD dwStyle,	const RECT& rect, CWnd* pParentWnd, UINT nID);
