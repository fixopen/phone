#ifndef __CONTROL_CDIBSECTIONCE_H__
#define __CONTROL_CDIBSECTIONCE_H__
...
#define DS_BITMAP_FILEMARKER  ((WORD) ('M' << 8) | 'B')    // is always "BM" = 0x4D42
    ...
    {
        //IMPLEMENT_SERIAL(CDIBSectionCE, CObject, VERSIONABLE_SCHEMA | 2)
        // Construction
    public:
        CDIBSectionCE();
...
#endif //__CONTROL_CDIBSECTIONCE_H__
