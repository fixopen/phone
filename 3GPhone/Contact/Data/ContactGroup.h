...
namespace Data {
    ...
    public:
        ...
        static std::vector<Util::shared_ptr<ContactGroup> > Select(std::wstring const& filter, std::wstring const& orderFieldName = "id", SeqenceRelation const dir = srNull, int const id = 0, int const pageSize = -1);
