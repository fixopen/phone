...
//		Util::Timestamp nightControlBlackLightEndTime_;
		...
		//特服号
		std::string	speCode1_;
		std::string	speCode2_;
		std::string	speCode3_;
		std::string	speCode4_;
		...
		int isSpecodeRing_;
		std::string specodeRingFilename_;
		int specodeRingVolume_;

		//pin设置
		int isPin_;
		std::string pinPassword_;

		//拨号设置
		int gprsType1_;
		std::string gprsHttp1_;
		std::string gprsDialnumber1_;
		std::string gprsProxyIp1_;
		int gprsProxyPort1_;

		int gprsType2_;
		std::string gprsHttp2_;
