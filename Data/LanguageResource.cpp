...
namespace Data
{
	...
	std::vector<boost::shared_ptr<LanguageResource> > LanguageResource::GetFromDatabase(std::string filter)
	{
		return DataAccess<LanguageResource>::GetDatasByFilter(filter, modifyFieldByDB_);
	}
