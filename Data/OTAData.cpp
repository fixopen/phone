...
namespace Data
{
    ...
    std::string const SMSCTimestamp::ToString() const {
        ...
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(year));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(month));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(day));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(hour));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(minite));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(second));
        result += Reverse(l);
        sprintf_s(l, 3, "%02X", Util::StringOp::FromInt(timezone));
        result += Reverse(l);
        return result;
    }
    ...
    std::string const SMSCTimestamp::ToString_() const {
        ...
        sprintf_s(l, 5, "%04d", (year + 2000));
        result += l;
        sprintf_s(l, 5, "%02d", (month));
        result += (l);
        sprintf_s(l, 5, "%02d", (day));
        result += (l);
        sprintf_s(l, 5, "%02d", (hour));
        result += (l);
        sprintf_s(l, 5, "%02d", (minite));
        result += (l);
        sprintf_s(l, 5, "%02d", (second));
        result += (l);
        return result;
    }
