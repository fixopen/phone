...
namespace Data
{
	...
	std::vector<boost::shared_ptr<User> > User::GetFromDatabase(std::string filter)
	{
		std::vector<boost::shared_ptr<User> > result = DataAccess<User>::GetDatasByFilter(filter, modifyFieldByDB_);
