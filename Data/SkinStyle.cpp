...
namespace Data
{
    ...
    COLORREF g_allInRectLine1RGB[2][4] = {{RGB(0, 107, 150)}, {RGB(140, 214, 24)}};
    ...
    COLORREF g_mainTxtColor[3][4] = {{RGB(255, 0, 0)}, {RGB(0, 255, 0)}, {RGB(255, 0, 255)}};

    //static border 颜色
    COLORREF g_staticLine1RGB[2][4] = {{8, 74, 90}, {8, 74, 90}};
    COLORREF g_staticLine2RGB[2][4] = {{16, 132, 173}, {8, 123, 165}};
    COLORREF g_staticLine3RGB[2][4] = {{16, 165, 222}, {16, 132, 173}};
