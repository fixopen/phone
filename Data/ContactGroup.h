...
namespace Data {
    ...
    public:
        ...
        Util::shared_ptr<SoundSegment> ring(void);
    ...
    public:
        ...
        static std::vector<Util::shared_ptr<ContactGroup> > GetFromDatabase(std::string const& filter, std::string const& orderFieldName = "id", SeqenceRelation const dir = srNull, int const id = 0, int const pageSize = -1);
