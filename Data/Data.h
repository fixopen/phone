...
namespace Data
{
	...
	public:
        ...
        struct Parameter
        {
            Parameter(ModifyFieldByDB modifyFieldByDBinst)
	...
	public:
        ...
        static std::vector<boost::shared_ptr<T> > GetDatasByFilter(std::string const filter, ModifyFieldByDB modifyFieldByDB, int const maxCount = -1)
        {
