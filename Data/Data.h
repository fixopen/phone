...
//			cmd += ";COMMIT";
		...
		//lxz 20090324
		/*
		static void RemoveThread(void *cmd)
		{
			std::string cmd_ = (char *)cmd;
			ExecCommand(cmd_);
		}
		*/
...
// 			HANDLE hRemoveThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)RemoveThread, cmd.c_str(), 0, NULL);
...
// 			return true;
        ...
        static bool const RemoveDataById(int const id)
        {
			...
			return ExecCommand(cmd);
// 			HANDLE hRemoveThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)RemoveThread, (void *)(cmd.c_str()), 0, NULL);
// 			CloseHandle(hRemoveThread);
// 			return true;
        }
