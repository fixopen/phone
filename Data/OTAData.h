...
namespace Data
{
    ...
    class Register : public DataAccess<Register> {
        //REGISTER
    public:
    ...
    class RegisterReply : public DataAccess<RegisterReply> {
        //REGISTER
    public:
        enum Result {
            rSuccess = 0,
    ...
    class Weather : public DataAccess<Weather> {
        //WEATHERINFO
    public:
    ...
    class SoftwareDownload : public DataAccess<SoftwareDownload> {
        //SOFTWARELOAD
    public:
        struct SoftInfo {
            //SoftInfo
    ...
    class MultimediaDownload : public DataAccess<MultimediaDownload> {
        //FILELOAD
    public:
    ...
    class MenuManager : public DataAccess<MenuManager> {
        //MENU
    public:
        enum MenuOperator {
            oNew = 1,
