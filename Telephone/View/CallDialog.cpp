...
namespace Telephone {
    namespace View {
        ...
        , listener_(0)
        , hasCallId_(false) {
            Logical::PstnTelephone::Instance(); //init the telephone machine
        }
        ...
        void CallDialog::OnBnClickedButtonClose() {
            ...
            ClearDuration();
            Logical::PstnTelephone::Instance()->SoftHangup();
            Logical::PstnTelephone::Instance()->ClearCall();
            ShowWindow(SW_HIDE);
        }
        ...
        void CallDialog::OnBnClickedButtonReject() {
            Logical::PstnTelephone::Instance()->SoftHangup();
            //Logical::PstnTelephone::Instance()->fireEvent(PstnTelephone::eHangup, 0);
            Logical::PstnTelephone::Instance()->ClearCall();
        }

        void CallDialog::OnBnClickedButtonListen() {
            Logical::PstnTelephone::Instance()->SoftPickup();
            //Logical::PstnTelephone::Instance()->fireEvent(PstnTelephone::ePickup, 0);
            Logical::PstnTelephone::Instance()->SetConnectionType(Logical::PstnTelephone::ctHandsfree);
        }

        void CallDialog::OnBnClickedButtonHangup() {
            Logical::PstnTelephone::Instance()->SoftHangup();
            //Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eHangup, 0);
            Logical::PstnTelephone::Instance()->ClearCall();
        }
        ...
        void CallDialog::OnBnClickedButtonMute() {
            Logical::PstnTelephone::Instance()->Mute();
        }

        void CallDialog::OnBnClickedButtonStartRecord() {
            Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eStartRecord, 0);
        }

        void CallDialog::OnBnClickedButtonStopRecord() {
            Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eStopRecord, 0);
        }

        void CallDialog::dial_(wchar_t const keyCode) {
            //KillTimer(timers_[Logical::PstnTelephone::tDial]);
            //timers_.erase(Logical::PstnTelephone::tDial);
            //CString value;
            //CWnd* control = GetDlgItem(IDC_EDIT_NUMBER);
            //control->GetWindowTextW(value);
            //value += keyCode;
            ...
            //    Logical::PstnTelephone::Instance()->SetContact(contacts[0]);
            //}
            //timers_.insert(std::make_pair(Logical::PstnTelephone::tDial, SetTimer(Logical::PstnTelephone::tDial, Logical::PstnTelephone::tDial, 0)));
        }
        ...
        void CallDialog::callId_(Logical::CALLID_INFO* callId) {
            //KillTimer(timers_[Logical::PstnTelephone::tCallId]);
            //timers_.erase(Logical::PstnTelephone::tCallId);
            //SetNumber(Util::StringOp::ToUnicode(callId->number));
            //timers_.insert(std::make_pair(Logical::PstnTelephone::tCallId, SetTimer(Logical::PstnTelephone::tCallId, Logical::PstnTelephone::tCallId, 0)));
        ...
        void CallDialog::connect_() {
            ...
            //timers_.insert(std::make_pair(Logical::PstnTelephone::tConnect, SetTimer(Logical::PstnTelephone::tConnect, Logical::PstnTelephone::tConnect, 0)));
        ...
        void CallDialog::startRecord_() {
            ...
            //timers_.insert(std::make_pair(Logical::PstnTelephone::tRecord, SetTimer(Logical::PstnTelephone::tRecord, 1000, 0)));
        }
        ...
        void CallDialog::stopRecord_() {
            //KillTimer(timers_[Logical::PstnTelephone::tRecord]);
            //timers_.erase(Logical::PstnTelephone::tRecord);
        }

        void CallDialog::remoteHangup_() {
            //CWnd* control = GetDlgItem(IDC_STATIC_COMMUNICATION_STATUS);
            //control->SetWindowTextW(L"Remote Hangup!");
            //KillTimer(timers_[Logical::PstnTelephone::tConnect]);
            //timers_.erase(Logical::PstnTelephone::tConnect);
            //KillTimer(timers_[Logical::PstnTelephone::tRecord]);
            //timers_.erase(Logical::PstnTelephone::tRecord);
            //hasCallId_ = false;
        }
        ...
        void CallDialog::softDial_(std::wstring const& number) {
            KillTimer(timers_[Logical::PstnTelephone::tWaitConnect]);
            timers_.erase(Logical::PstnTelephone::tWaitConnect);
            SetNumber(number);
            timers_.insert(std::make_pair(Logical::PstnTelephone::tWaitConnect, SetTimer(Logical::PstnTelephone::tWaitConnect, Logical::PstnTelephone::tWaitConnect, 0)));
        }
        ...
        void CallDialog::OnTimer(UINT_PTR nIDEvent) {
            //if (nIDEvent == timers_[Logical::PstnTelephone::tDial]) {
            //    KillTimer(nIDEvent);
            //    timers_.erase(Logical::PstnTelephone::tDial);
            //    if (Util::Properties::Get(L"autoRecord") == L"1") {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eForceRecord, 0);
            //    } else {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eRemotePickup, 0);
            //    }
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tWaitReceive]) {
            //    KillTimer(nIDEvent);
            //    timers_.erase(Logical::PstnTelephone::tWaitReceive);
            //    if (Util::Properties::Get(L"autoRecord") == L"1") {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eForceRecord, 0);
            //    } else {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eRemotePickup, 0);
            //    }
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tRing]) {
            //    KillTimer(nIDEvent);
            //    timers_.erase(Logical::PstnTelephone::tRing);
            //    //if (ringCount > Util::Properties::Get(L"delayCount")) {
            //    //    Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eLeaveWord, 0);
            //    //} else {
            //    //    ++ringCount;
            //    //}
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tCallId]) {
            //    KillTimer(nIDEvent);
            //    timers_.erase(Logical::PstnTelephone::tCallId);
            //    if (Util::Properties::Get(L"autoAnswer") == L"1") {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eLeaveWord, 0);
            //    } else {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eTimeout, 0);
            //    }
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tWaitConnect]) {
            //    KillTimer(nIDEvent);
            //    timers_.erase(Logical::PstnTelephone::tWaitConnect);
            //    if (Util::Properties::Get(L"autoRecord") == L"1") {
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eForceRecord, 0);
            ...
            //        Logical::PstnTelephone::Instance()->fireEvent(Logical::PstnTelephone::eRemotePickup, 0);
            //    }
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tConnect]) {
            ...
            //} else if (nIDEvent == timers_[Logical::PstnTelephone::tRecord]) {
