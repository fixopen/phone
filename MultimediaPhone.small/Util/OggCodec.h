...
//#include "../inc/speex/speex_bits.h"
...
#define writeint(buf, base, val) do{ buf[base+3]=((val)>>24)&0xff; \
    ...
    public:
        ...
        void EncodeFile(std::string encodeFileName);
        void DecodeFile(std::string decodeFileName);
