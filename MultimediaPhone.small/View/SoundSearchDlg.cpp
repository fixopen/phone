...
namespace View {
    ...
    BOOL CSoundSearchDlg::OnInitDialog() 
    {
        ...
        */
        ...
        m_dtFrom.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(146 + 54, 122 + 62, 146 + 184 + 54, 122 + 32 + 62), this, IDC_DATETIME_SOUNDSEARCH_FROM, 28, CDateCtrl::modeDate);
        m_dtTo.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(360 + 54, 122 + 62, 360 + 184 + 54, 122 + 32 + 62), this, IDC_DATETIME_SOUNDSEARCH_TO, 28, CDateCtrl::modeDate);
        m_Font.CreateFont(
            28,                        // nHeight
            0,                         // nWidth
            0,                         // nEscapement
