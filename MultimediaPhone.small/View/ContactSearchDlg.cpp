...
namespace View {
    ...
    BOOL CContactSearchDlg::OnInitDialog() 
    {
        ...
        */
        m_edtName.Create(WS_CHILD|WS_VISIBLE, CRect(142 + 54, 115 + 62, 522 + 54, 145 + 62), this, IDC_EDIT_CONTACTSEARCH_NAME);
        m_edtName.SetLimitText(15);

        m_edtNumber.Create(WS_CHILD|WS_VISIBLE, CRect(142 + 54, 156 + 62, 522 + 54, 186 + 62), this, IDC_EDIT_CONTACTSEARCH_NUMBER);
        m_edtNumber.SetLimitText(15);
        m_edtNumber.SetLimitDiagital();

        m_edtCompany.Create(WS_CHILD|WS_VISIBLE, CRect(142 + 54, 197 + 62, 522 + 54, 227 + 62), this, IDC_EDIT_CONTACTSEARCH_COMPANY);
        m_edtCompany.SetLimitText(15);

        m_edtDuty.Create(WS_CHILD|WS_VISIBLE, CRect(142 + 54, 238 + 62, 522 + 54, 268 + 62), this, IDC_EDIT_CONTACTSEARCH_DUTY);
