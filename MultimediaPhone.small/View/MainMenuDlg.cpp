...
namespace View {
    ...
    void CMainMenuDlg::OnVideoBtn() 
    {
        ...
        main->m_pMainDlg->m_mainVideoDlg_->SetPlayList((TCHAR*)(LPCTSTR)::videoPath, 0);
    ...
    void CMainMenuDlg::OnPhotoBtn() 
    {
        // TODO: Add your control notification handler code here
        CMultimediaPhoneDlg* main = (CMultimediaPhoneDlg*)theApp.m_pMainWnd;
        main->m_pMainDlg->m_mainPhotoDlg_->SetPlayList((TCHAR*)(LPCTSTR)::photoPath, 0);
    ...
    {
        CMultimediaPhoneDlg* main = (CMultimediaPhoneDlg*)theApp.m_pMainWnd;
        main->m_pMainDlg->m_mainMp3Dlg_->SetPlayList((TCHAR*)(LPCTSTR)::musicPath, 0);
