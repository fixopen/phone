...
namespace Control {
    ...
    BEGIN_MESSAGE_MAP(CDateCtrl, CEdit)
        ...
        ON_MESSAGE(UM_BTN_DOWN, OnSubBtnDown)
    END_MESSAGE_MAP()
    ...
    LRESULT CDateCtrl::OnSubBtnDown(WPARAM wParam, LPARAM lParam)
    {
        LRESULT result = 0;
        return result;
    }

    void CDateCtrl::Increase()
    {
        CString strTemp;
        TCHAR tBuf[16] = {0};
