...
BOOL CCEBmpButton::Create(LPCTSTR lpszCaption, int nIDUp, int nIDDown, DWORD dwStyle,	const RECT& rect, CWnd* pParentWnd, UINT nID, int fontSize)
{
	m_nBitmapUp = nIDUp;
...
void CCEBmpButton::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
	...
	//	CDC *pdc = GetDC();
		...
		TransparentBlt2(pdc->m_hDC, \
			rect.left, rect.top, rect.Width (), rect.Height(),\
			memDC.m_hDC, m_nBmpOffx, m_nBmpOffy, rect.Width(), rect.Height(),\
			RGB(0xFF, 0, 0xFF));
...
void CCEBmpButton::SetFontSize(int size)
{
	m_Font.DeleteObject();
