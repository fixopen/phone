...
//globle data
CString gLangName[] = {
    ".\\adv\\mjpg\\中文\\playcfg.xml", ".\\adv\\mjpg\\英文\\playcfg.xml", ".\\adv\\mjpg\\日文\\playcfg.xml", ".\\adv\\mjpg\\韩文\\playcfg.xml"
};
CString gAdvPlayList = ".\\adv\\video\\advplaylist.xml";
CString gFontName[] = {
    "宋体", "黑体", "Arial", "Times New Roman"
};
UINT gFontWeights[] = {
    FW_NORMAL, FW_BOLD
};
...
COLORREF gFontColor[] = {
    RGB(0, 0, 0), RGB(255, 255, 255), RGB(255, 0, 0), RGB(0, 0, 255), RGB(0, 100, 0), RGB(255, 255, 0)
};
UINT gFontAlign[] = {
    DT_WORDBREAK | DT_NOPREFIX | DT_EDITCONTROL, DT_WORDBREAK | DT_NOPREFIX | DT_EDITCONTROL, DT_WORDBREAK | DT_NOPREFIX | DT_EDITCONTROL
};
...
CString CMJPGStatic::ToFileDir(CString filename) {
    ...
    sDirName = nandflash_resource_dir;
...
void CMJPGStatic::SetCurrentLinkFile(CString s) {
    ...
    if (m_currentMJPGList) {
        m_nIsCrollIndex = -1;
        m_nIsCrollCount = 0;
        for (size_t i = 0; i < m_currentMJPGList->items.size(); i++) {
...
void CMJPGStatic::DrawUnitStatus_HDC(UNIT* pUnit, int nUintStatus) {
    ...
    if (sUintJpg != "" || sAllJpg != "") {
        ...
        if (pUnit->m_sContent != "") {
            ...
            VERIFY(m_Font.CreateFont(gFontSize[pUnit->m_FontSize],                        // nHeight
                0,                         // nWidth
                0,                         // nEscapement
                0,                         // nOrientation
                gFontWeights[pUnit->m_FontWeights],//FW_NORMAL,       // nWeight
