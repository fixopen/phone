...
namespace Data
{
    ...
    : type_(stCurrent)
	{
		isAutoAppendOutlinePrefix_ = false;
		isAppendIpPrefix_ = false;
		isUseSpecRing_ = false;
		isAutoReply_ = false;
		autoReplyRingCount_ = 0;
		linkMode_ = lmNull;
		ipMode_ = imNull;
        isIndicationUser_ = false;
        isAlwaysSave_ = false;	
		memorySize_ = 0; //readonly
		memoryUsedSize_ = 0; //readonly
		storageSize_ = 0; //readonly
		storageUsedSize_ = 0; //readonly
		contactUseSize_ = 0; //readonly
		contactInfoUseSize_ = 0; //readonly
		soundUseSize_ = 0; //readonly
        maxContactUseSize_ = 0;
        maxContactInfoUseSize_ = 0;
        maxSoundUseSize_ = 0;
        soundVolume_ = 0;
        thisUserId_ = 0;
		screenSaverContent_ = sscClock;
		isFirewall_ = false;
		firewallType_ = fwtNull;;
		isUseScreenSaver_ = false;
		isUseScreenSaverPassword_ = false;
	}
