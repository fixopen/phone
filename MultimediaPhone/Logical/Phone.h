...
namespace Logical
{
    ...
    class RecordThread;
    class PlayThread;
    class MyPhone : public Util::Thread
    {
        friend RecordThread;
        friend PlayThread;
    public:
    ...
    public:
        MyPhone(PickupFunc pickup, HandsfreeFunc handsfree, HangupFunc hangup, KeypadDialFunc keypadDial, ConnectFunc connect, RingInFunc ringIn, RemoteHangupFunc remoteHangup, TimeoutFunc timeout, ErrorFunc error); //init phone system
        ~MyPhone(); //destory phone system
        void Dial(Data::TelephoneNumber number);
        Util::shared_ptr<Data::ContactInfo> GetContactInfo() const;
    ...
    private:
        ...
        Util::shared_ptr<Data::ContactInfo> contactInfo_;
