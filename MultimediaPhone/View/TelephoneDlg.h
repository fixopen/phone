...
namespace View {
    ...
    private:
        ...
        //	CNoteDlg* m_pNoteDlg;
        //	Util::shared_ptr<Data::SimAddr> m_spSimAddr;


        Util::shared_ptr<Data::ContactInfo> m_spContactInfo;
        Util::shared_ptr<Data::SoundSegment> m_spSoundSegment;
        std::vector<Util::shared_ptr<Data::SoundSegment> >m_vSoundSegment;
        CString m_strRecord;
    ...
    public:
        ...
        std::vector<Util::shared_ptr<Data::Contact> > FindCallContact(std::string number);
        void ShowContact(Util::shared_ptr<Data::Contact> contact, std::string number);
