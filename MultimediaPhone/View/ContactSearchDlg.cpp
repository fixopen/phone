...
namespace View {
    ...
    LRESULT CContactSearchDlg::OnClickMJPG(WPARAM w, LPARAM l)
    {
        LRESULT result = 0;
        switch(w)
        {
    ...
    BOOL CContactSearchDlg::OnInitDialog() 
    {
        ...
        */
        ...
        m_MJPGList.SetCurrentLinkFile(_T(".\\adv\\mjpg\\k1\\ÖĞÎÄ\\²éÕÒ.xml"));
        m_MJPGList.SetMJPGRect(CRect(54*X_XISHU, 62*Y_XISHU, 746*X_XISHU, 358*Y_XISHU));

        m_edtName.Create(WS_CHILD|WS_VISIBLE, CRect((142 )*X_XISHU, (115 )*Y_XISHU, (522 )*X_XISHU, (145 )*Y_XISHU), &m_MJPGList, IDC_EDIT_CONTACTSEARCH_NAME);
        m_edtName.SetLimitText(15);

        m_edtNumber.Create(WS_CHILD|WS_VISIBLE, CRect((142 )*X_XISHU, (156 )*Y_XISHU, (522 )*X_XISHU, (186 )*Y_XISHU),  &m_MJPGList, IDC_EDIT_CONTACTSEARCH_NUMBER);
        m_edtNumber.SetLimitText(15);
        m_edtNumber.SetLimitDiagital();

        m_edtCompany.Create(WS_CHILD|WS_VISIBLE, CRect((142 )*X_XISHU, (197 )*Y_XISHU, (522 )*X_XISHU, (227 )*Y_XISHU),  &m_MJPGList, IDC_EDIT_CONTACTSEARCH_COMPANY);
        m_edtCompany.SetLimitText(15);

        m_edtDuty.Create(WS_CHILD|WS_VISIBLE, CRect((142 )*X_XISHU, (238 )*Y_XISHU, (522 )*X_XISHU, (268 )*Y_XISHU),  &m_MJPGList, IDC_EDIT_CONTACTSEARCH_DUTY);
