...
namespace Util {
    ...
    public: //native charset interface
        ...
        static RECT const ToRectangle(std::string const& content);//[(x0,y0)(x1,y1)]
    ...
    public: //unicode charset interface
        ...
        static RECT const ToRectangle(std::wstring const& content);//[(x0,y0)(x1,y1)]
        ...
        static std::wstring const FromRectangle(RECT const& rect);
