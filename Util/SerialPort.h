...
namespace Util {
    ...
    public:
        ...
        bool Open(unsigned int portNo = 1, unsigned int baud = 9600, unsigned int parity = NOPARITY, unsigned int databits = 8, unsigned int stopbits = 1);
        bool Write(unsigned char const* const data, unsigned int length);
        void Close(void);
    private:
