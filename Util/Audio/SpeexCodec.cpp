...
namespace Util {
    namespace Audio {
        ...
        void SpeexCodec::InitEncode(SpeexMode const& mode, size_t const frameSize, size_t const quality) {
            //SpeexBits bits;
        ...
        std::string const SpeexCodec::Encode(spx_int16_t* in, size_t const length) {
        ...
        void SpeexCodec::UninitEncode() {
            speex_encoder_destroy(enc_state_);
            speex_bits_destroy(&bits_);
        }

        void SpeexCodec::InitDecode(SpeexMode const& mode, size_t const frameSize, int const enh) {
            SpeexBits bits_;
            speex_bits_init(&bits_);
        ...
        std::wstring const SpeexCodec::Decode(char* in, size_t const length) {
