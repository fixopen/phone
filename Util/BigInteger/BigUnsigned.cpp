...
unsigned long  BigUnsigned::toUnsignedLong () const { return convertToPrimitive      (0ul); }
unsigned int   BigUnsigned::toUnsignedInt  () const { unsigned int r = 0; return convertToPrimitive      (r); }
unsigned short BigUnsigned::toUnsignedShort() const { unsigned short r = 0; return convertToPrimitive      (r); }
long           BigUnsigned::toLong         () const { return convertToSignedPrimitive(0l); }
int            BigUnsigned::toInt          () const { return convertToSignedPrimitive(0); }
short          BigUnsigned::toShort        () const { short r = 0; return convertToSignedPrimitive(r); }
// BIT/BLOCK ACCESSORS
