...
namespace Util {
    ...
    RECT const StringOp::ToRectangle(std::string const& content) {
    ...
    RECT const StringOp::ToRectangle(std::wstring const& content) {
        RECT result;
        result.left = 0;
        result.top = 0;
        result.right = 0;
...
//
    ...
    std::wstring const StringOp::FromRectangle(RECT const& rect) {
