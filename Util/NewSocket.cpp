...
void CNewSocket::OnAccept(int nErrorCode) {
    ...
    /*CCeSocket*/CSocket::OnAccept(nErrorCode);
}
...
void CNewSocket::OnReceive(int nErrorCode) {
    ...
    /*
    FILE *fl = fopen("/NandFlash/resource/123.dat", "w+b");
    if(fl)
    {
    ...
    */
    /*CCeSocket*/CSocket::OnReceive(nErrorCode);
}

int CNewSocket::Receive(void* lpBuf, int nBufLen, int nFlags) {
    // TODO: Add your specialized code here and/or call the base class

    return /*CCeSocket*/CSocket::Receive(lpBuf, nBufLen, nFlags);
}

int CNewSocket::Send(const void* lpBuf, int nBufLen, int nFlags) {
    // TODO: Add your specialized code here and/or call the base class

    return /*CCeSocket*/CSocket::Send(lpBuf, nBufLen, nFlags);
}
