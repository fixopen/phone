================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : RecordPhone Project Overview
===============================================================================

The application wizard has created this RecordPhone application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your RecordPhone application.
...
RecordPhone.h
    ...
    project specific headers and declares the CRecordPhoneApp application class.

RecordPhone.cpp
    This is the main application source file that contains the application
    class CRecordPhoneApp.
...
RecordPhoneDlg.h, RecordPhoneDlg.cpp - the dialog
    These files contain your CRecordPhoneDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named RecordPhone.pch and a precompiled types file named StdAfx.obj.
