...
namespace View {
    ...
    private:
        ...
        */
        ...
        std::vector<Util::shared_ptr<Data::ContactInfo> > m_vCurrentResult;
        void ShowArrayInList(std::vector<Util::shared_ptr<Data::ContactInfo> > array);
    ...
    public:
        ...
        void SaveContactInfo(Util::shared_ptr<Data::ContactInfo> ci);
