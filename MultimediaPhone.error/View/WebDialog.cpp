...
#define WM_BROW_URL		WM_USER+104
    ...
    BOOL CWebDialog::OnInitDialog()
    {
        ...
        m_edit.Create(WS_CHILD|WS_VISIBLE, CRect(368*X_XISHU, 1*Y_XISHU, 693*X_XISHU, 42*Y_XISHU), &m_MJPGList, 0xFFFF, 24);
        m_edit.SetWindowText(L"");

        m_cmbURL.Create(WS_CHILD|WS_VISIBLE, CRect(368*X_XISHU, 1*Y_XISHU, 750*X_XISHU, 400*Y_XISHU), &m_MJPGList, IDC_COMBOBOX_SETTING_RINGTIMES);
