...
#define IDC_SETTING_LSTUSB				9019
    ...
    BOOL CSettingDlg::OnInitDialog() 
    {
        ...
        */
        ...
        m_cmbRingTimes.Create(WS_CHILD|WS_VISIBLE, CRect(353*X_XISHU, 304*Y_XISHU, 466*X_XISHU, 460*Y_XISHU), &m_MJPGList, IDC_COMBOBOX_SETTING_RINGTIMES);
        m_cmbAutoRecoedeTimes.Create(WS_CHILD|WS_VISIBLE, CRect(562*X_XISHU, 304*Y_XISHU, 675*X_XISHU, 460*Y_XISHU), &m_MJPGList, IDC_COMBOBOX_SETTING_RINGTIMES);
