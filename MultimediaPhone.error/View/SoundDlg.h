...
namespace View {
    ...
    private:
        ...
        */
        ...
        void ShowArrayInList(std::vector<Util::shared_ptr<Data::SoundSegment> > array, int type = -1);
        ...
        std::vector<Util::shared_ptr<Data::SoundSegment> > m_vCurrentResult;
        std::vector<Util::shared_ptr<Data::SoundSegment> > m_vSearchResult;
        void ScrollItemsInList(int step, int nPos);
    public:
        CRecordSoundDlg* m_pRecordSoundDlg;
        CPlaySoundDlg* m_pPlaySoundDlg;

        void SaveSoundSegment(Util::shared_ptr<Data::SoundSegment> ss);
