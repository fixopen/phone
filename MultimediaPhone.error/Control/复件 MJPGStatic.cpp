...
namespace Control {
    ...
    //globle data
    CString gLangName[] = {_T(".\\adv\\mjpg\\中文\\playcfg.xml"), _T(".\\adv\\mjpg\\英文\\playcfg.xml"), _T(".\\adv\\mjpg\\日文\\playcfg.xml"), _T(".\\adv\\mjpg\\韩文\\playcfg.xml")};
    CString gAdvPlayList = _T(".\\adv\\video\\advplaylist.xml");
    CString gFontName[] = {_T("宋体"), _T("黑体"), _T("Arial"), _T("Times New Roman")};
