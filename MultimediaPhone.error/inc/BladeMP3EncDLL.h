...
#define	TEXT_BEINITSTREAM				_T("beInitStream")
#define	TEXT_BEENCODECHUNK				_T("beEncodeChunk")
#define	TEXT_BEENCODECHUNKFLOATS16NI	_T("beEncodeChunkFloatS16NI")
#define	TEXT_BEDEINITSTREAM				_T("beDeinitStream")
#define	TEXT_BECLOSESTREAM				_T("beCloseStream")
#define	TEXT_BEVERSION					_T("beVersion")
#define	TEXT_BEWRITEVBRHEADER			_T("beWriteVBRHeader")
#define	TEXT_BEFLUSHNOGAP				_T("beFlushNoGap")
#define	TEXT_BEWRITEINFOTAG				_T("beWriteInfoTag")
