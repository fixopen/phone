...
//	m_pScheduler = boost::shared_ptr<Data::Scheduler>();
	...
	m_dtDate.Create(WS_CHILD|DTS_SHORTDATEFORMAT, CRect(125, 67, 125+184, 67+32), this, IDC_SETTING_DATE, 28, CDateCtrl::em_mode::modeDate);
	m_dtTime.Create(WS_CHILD|DTS_TIMEFORMAT, CRect(346, 67, 346+154, 67+32), this, IDC_SETTING_TIME, 28, CDateCtrl::em_mode::modeTime);
