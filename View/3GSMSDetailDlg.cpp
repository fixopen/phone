...
void C3GSMSDetailDlg::initDataBase(SMSDETAILTYPE type, int smsid, BOOL reDraw) {
    char* title[] = {
        ".\\adv\\mjpg\\k1\\common\\3g\\短信阅读-新建标题.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信阅读-阅读信息标题.bmp"
    };
    char* senderTitle[] = {
        ".\\adv\\mjpg\\k1\\common\\3g\\短信阅读-收件人.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信阅读-发件人.bmp"
    };
    char* newbuttonTile[][2] = {
        ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读发送1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读发送2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读存贮1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读存贮2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读复制1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读复制2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读粘贴1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读粘贴2.bmp"
    };
    char* readbuttonTile[][2] = {
        ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读回复1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读回复2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读回电2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读回电2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读转发1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读转发2.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读删除1.bmp", ".\\adv\\mjpg\\k1\\common\\3g\\短信-阅读删除2.bmp"
    };
    m_nSMSType = type;          
    m_nSMSId = smsid;
        ...
        //发送
        {
            if (m_nSMSType == SMS_NEW) {
                ...
                if (s != "" && s_ != "") {
                    ...
                    SYSTEMTIME tm;
                    GetLocalTime(&tm);
                    m_pMessageData->timestamp.year = static_cast<unsigned char>(tm.wYear % 100);
                    m_pMessageData->timestamp.month = static_cast<unsigned char>(tm.wMonth);
                    m_pMessageData->timestamp.day = static_cast<unsigned char>(tm.wDay);
                    m_pMessageData->timestamp.hour = static_cast<unsigned char>(tm.wHour);
                    m_pMessageData->timestamp.minite = static_cast<unsigned char>(tm.wMinute);
                    m_pMessageData->timestamp.second = static_cast<unsigned char>(tm.wSecond);
                ...
                if (s_ != "" && ret) {
                    ...
                    sprintf_s(datetime, 24, "%04d%02d%02d%02d%02d%02d", tm.wYear, tm.wMonth, tm.wDay, tm.wHour, tm.wMinute, tm.wSecond);
                    sprintf_s(sDir, 64, flashdrv_3g_mms, datetime);
                    CString sDir_ = sDir;
