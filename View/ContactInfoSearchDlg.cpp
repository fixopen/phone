...
*/
	...
	m_dtFrom.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(146 + 54, 119 + 62, 146 + 184 + 54, 119 + 32 + 62), this, IDC_DATETIME_CONTACTINFOSEARCH_FROM, 28, CDateCtrl::em_mode::modeDate);
	m_dtTo.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(360 + 54, 119 + 62, 360 + 184 + 54, 119 + 32 + 62), this, IDC_DATETIME_CONTACTINFOSEARCH_TO, 28, CDateCtrl::em_mode::modeDate);
	m_Font.CreateFont(
		28,                        // nHeight
		0,                         // nWidth
		0,                         // nEscapement
