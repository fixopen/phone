...
BOOL CContactInfoSearchDlg::OnInitDialog() {
    ...
    */
    m_edtName.Create(WS_CHILD | WS_VISIBLE, CRect(144 + 54, 169 + 62, 524 + 54, 199 + 62), this, IDC_EDIT_CONTACTINFOSEARCH_NAME);
    m_edtName.SetLimitText(15);

    m_edtNumber.Create(WS_CHILD | WS_VISIBLE, CRect(144 + 54, 213 + 62, 524 + 54, 243 + 62), this, IDC_EDIT_CONTACTINFOSEARCH_NUMBER);
    m_edtNumber.SetLimitText(15);
    m_edtNumber.SetLimitDiagital();

    m_dtFrom.Create(WS_VISIBLE | WS_CHILD | DTS_SHORTDATEFORMAT, CRect(146 + 54, 119 + 62, 146 + 184 + 54, 119 + 32 + 62), this, IDC_DATETIME_CONTACTINFOSEARCH_FROM, 28, CDateCtrl::modeDate);
    m_dtTo.Create(WS_VISIBLE | WS_CHILD | DTS_SHORTDATEFORMAT, CRect(360 + 54, 119 + 62, 360 + 184 + 54, 119 + 32 + 62), this, IDC_DATETIME_CONTACTINFOSEARCH_TO, 28, CDateCtrl::modeDate);
    ...
    */
    ...
    m_MJPGList.SetCurrentLinkFile(".\\adv\\mjpg\\k1\\中文\\通话记录查找.xml");
...
void CContactInfoSearchDlg::OnButtonSearchcinfoSearch() {
    ...
    char buff[32];
    memset(buff, 0, 32);
    sprintf_s(buff, 32, "%04d%02d%02d000000", dateFrom.GetYear(), dateFrom.GetMonth(), dateFrom.GetDay());//, dateFrom.GetHour(), dateFrom.GetMinute(), dateFrom.GetSecond());
    filter += buff;
    filter += "' AND '";
    memset(buff, 0, 32);
    sprintf_s(buff, 32, "%04d%02d%02d235959", dateTo.GetYear(), dateTo.GetMonth(), dateTo.GetDay());//, dateTo.GetHour(), dateTo.GetMinute(), dateTo.GetSecond());
    filter += buff;
    filter += "'";
