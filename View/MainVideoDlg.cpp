...
namespace View {
    ...
    BOOL CMainVideoDlg::OnInitDialog() 
    {
        ...
        m_MJPGList.SetMJPGRect(CRect(0*X_XISHU, 0, 535*X_XISHU, 420));

        m_prgPlayTime.Create(WS_CHILD|WS_VISIBLE, CRect(5*X_XISHU, 268*Y_XISHU, (5+393)*X_XISHU, (268+16)*Y_XISHU), &m_MJPGList, IDC_PROGRESS_VIDEOTIME);
        ...
        m_prgSoundSelect.Create(WS_CHILD|WS_VISIBLE, CRect(498*X_XISHU, 313*Y_XISHU, (498+27)*X_XISHU, (313+90)*Y_XISHU), &m_MJPGList,IDC_PROGRESS_VIDEOSOUND);
