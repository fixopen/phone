...
void CFireWallDlg::OnButtonFireWallCancel() {
    ShowWindow(FALSE);
    OnStart(FALSE);
    SetParameters(((CMultimediaPhoneDlg *)(theApp.m_pMainWnd))->m_pSettingDlg->m_pSetting->isFirewall(), ((CMultimediaPhoneDlg *)(theApp.m_pMainWnd))->m_pSettingDlg->m_pSetting->firewallType(), (int)((CMultimediaPhoneDlg *)(theApp.m_pMainWnd))->m_pSettingDlg->m_pSetting->blockAllTimeDuration().GetTotalSeconds());
    ((CMultimediaPhoneDlg *)(theApp.m_pMainWnd))->m_pMainDlg->SetStatusAll(FALSE);
}
