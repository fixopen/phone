...
*/
	m_cmbType.Create(WS_CHILD|WS_VISIBLE, CRect(292, 68, 410, 410), this, IDC_COMBOBOX_CONTACTNEW_TYPE);
	m_cmbGroup.Create(WS_CHILD|WS_VISIBLE, CRect(468, 68, 682, 410), this, IDC_COMBOBOX_CONTACTNEW_GROUP);
	...
	m_edtName.Create(WS_CHILD|WS_VISIBLE, CRect(80, 75, 280, 105), this, IDC_EDIT_CONTACTNEW_NAME);
	m_edtName.SetWindowText(L"");
	m_edtName.SetLimitText(15);
	m_edtMobile1.Create(WS_CHILD|WS_VISIBLE, CRect(80, 123, 280, 153), this, IDC_EDIT_CONTACTNEW_MOBILE1);
	m_edtMobile1.SetLimitText(15);
	m_edtMobile2.Create(WS_CHILD|WS_VISIBLE, CRect(80, 173, 280, 203), this, IDC_EDIT_CONTACTNEW_MOBILE2);
	m_edtMobile2.SetLimitText(15);
	m_edtTelephone1.Create(WS_CHILD|WS_VISIBLE, CRect(80, 222, 280, 252), this, IDC_EDIT_CONTACTNEW_TELEPHONE1);
	m_edtTelephone1.SetLimitText(15);
	m_edtTelephone2.Create(WS_CHILD|WS_VISIBLE, CRect(80, 271, 280, 301), this, IDC_EDIT_CONTACTNEW_TELEPHONE2);
	...
	m_edtEmail.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(80, 320, 280, 350), this, IDC_EDIT_CONTACTNEW_EMAIL);
	m_edtEmail.SetLimitText(30);
	m_edtSite.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(80, 369, 280, 399), this, IDC_EDIT_CONTACTNEW_SITE);
	m_edtSite.SetLimitText(30);

	m_edtCompany.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475, 123, 675, 153), this, IDC_EDIT_CONTACTNEW_COMPANY);
	m_edtCompany.SetLimitText(30);
	m_edtCompanyAddress.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475, 173, 675, 203), this, IDC_EDIT_CONTACTNEW_ADDRESS);
	m_edtCompanyAddress.SetLimitText(30);
	m_edtPostCode.Create(WS_CHILD|WS_VISIBLE, CRect(475, 222, 675, 252), this, IDC_EDIT_CONTACTNEW_POSTCODE);
	m_edtPostCode.SetLimitText(6);
	m_edtPostCode.SetLimitDiagital();

	m_edtDepartment.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475, 271, 675, 301), this, IDC_EDIT_CONTACTNEW_DEPARTMENT);
	m_edtDepartment.SetLimitText(30);
	m_edtDuty.Create(WS_CHILD|WS_VISIBLE, CRect(475, 320, 675, 350), this, IDC_EDIT_CONTACTNEW_DUTY);
	m_edtDuty.SetLimitText(15);
	m_edtMemo.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475, 369, 675, 399), this, IDC_EDIT_CONTACTNEW_MEMO);
