	...
	case 20:
		{
			...
			if(s != "")
			{
				C3GSMSDetailDlg *pWnd_ = ((CMultimediaPhoneDlg*)theApp.m_pMainWnd)->m_pMainDlg->m_p3GSMSDlg->m_pSMSDetailDlg;
	...
	case 21:
		{
			...
			{
				C3GSMSDetailDlg *pWnd_ = ((CMultimediaPhoneDlg*)theApp.m_pMainWnd)->m_pMainDlg->m_p3GSMSDlg->m_pSMSDetailDlg;
				pWnd_->initDataBase(MMS_NEW, -1, FALSE);
				pWnd_->SetSMSDetail(s, "");
				pWnd_->ShowWindow(SW_SHOW);
			}
		}
...
*/
	m_cmbType.Create(WS_CHILD|WS_VISIBLE, CRect(292-8, 68-4, 410-8, 410-4), this, IDC_COMBOBOX_CONTACTNEW_TYPE);
	m_cmbGroup.Create(WS_CHILD|WS_VISIBLE, CRect(468-4, 68-4, 682-8, 410-4), this, IDC_COMBOBOX_CONTACTNEW_GROUP);
	...
	m_edtName.Create(WS_CHILD|WS_VISIBLE, CRect(80-8, 75-4, 280-8, 105-4), this, IDC_EDIT_CONTACTNEW_NAME);
	m_edtName.SetWindowText(L"");
	m_edtName.SetLimitText(15);
	m_edtMobile1.Create(WS_CHILD|WS_VISIBLE, CRect(80-8, 123-4, 280-8, 153-4), this, IDC_EDIT_CONTACTNEW_MOBILE1);
	m_edtMobile1.SetLimitText(15);
	m_edtMobile2.Create(WS_CHILD|WS_VISIBLE, CRect(80-8, 173-4, 280-8, 203-4), this, IDC_EDIT_CONTACTNEW_MOBILE2);
	m_edtMobile2.SetLimitText(15);
	m_edtTelephone1.Create(WS_CHILD|WS_VISIBLE, CRect(80-8, 222-4, 280-8, 252-4), this, IDC_EDIT_CONTACTNEW_TELEPHONE1);
	m_edtTelephone1.SetLimitText(15);
	m_edtTelephone2.Create(WS_CHILD|WS_VISIBLE, CRect(80-8, 271-4, 280-8, 301-4), this, IDC_EDIT_CONTACTNEW_TELEPHONE2);
	...
	m_edtEmail.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(80-8, 320-4, 280-8, 350-4), this, IDC_EDIT_CONTACTNEW_EMAIL);
	m_edtEmail.SetLimitText(30);
	m_edtSite.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(80-8, 369-4, 280-8, 399-4), this, IDC_EDIT_CONTACTNEW_SITE);
	m_edtSite.SetLimitText(30);

	m_edtCompany.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475-8, 123-4, 675-8, 153-4), this, IDC_EDIT_CONTACTNEW_COMPANY);
	m_edtCompany.SetLimitText(30);
	m_edtCompanyAddress.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475-8, 173-4, 675-8, 203-4), this, IDC_EDIT_CONTACTNEW_ADDRESS);
	m_edtCompanyAddress.SetLimitText(30);
	m_edtPostCode.Create(WS_CHILD|WS_VISIBLE, CRect(475-8, 222-4, 675-8, 252-4), this, IDC_EDIT_CONTACTNEW_POSTCODE);
	m_edtPostCode.SetLimitText(6);
	m_edtPostCode.SetLimitDiagital();

	m_edtDepartment.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475-8, 271-4, 675-8, 301-4), this, IDC_EDIT_CONTACTNEW_DEPARTMENT);
	m_edtDepartment.SetLimitText(30);
	m_edtDuty.Create(WS_CHILD|WS_VISIBLE, CRect(475-8, 320-4, 675-8, 350-4), this, IDC_EDIT_CONTACTNEW_DUTY);
	m_edtDuty.SetLimitText(15);
	m_edtMemo.Create(WS_CHILD|WS_VISIBLE|ES_AUTOHSCROLL, CRect(475-8, 369-4, 675-8, 399-4), this, IDC_EDIT_CONTACTNEW_MEMO);
...
*/
	...
	m_MJPGList.SetCurrentLinkFile(".\\adv\\mjpg\\k1\\中文\\新建名片.xml");
...
char* CContactNewDlg::LoadPinYinIndex(void)
{
	...
	m_pHexFile.Open(_T("/hive/res/firstchar.txt"), CFile::modeRead | CFile::typeBinary);   
