...
/////////////////////////////////////////////////////////////////////////////
// CSettingDlg dialog
CString s_VerSionTitle = "6.00090319";
CString s_VerSion = "\
					   6.00090319\
1.改为录音程序\
2.50090302\
...
// 	m_stcTime.SetColor(RGB(0, 0, 0), Data::g_allFramInRectBackRGB[Data::g_skinstyle]);
	m_dtDate.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(319-13, 317-4, 319+184-13, 317+32-4), this, IDC_SETTING_DATE, 28, CDateCtrl::em_mode::modeDate);
	m_dtTime.Create(WS_VISIBLE|WS_CHILD|DTS_TIMEFORMAT, CRect(521-13, 317-4, 521+154-13, 317+32-4), this, IDC_SETTING_TIME, 28,  CDateCtrl::em_mode::modeTime);
...
//	m_dtDate.SetRange(&time1, &time2);
	...
	//录音设置
	m_chbSettingPlayPassWord.Create(L"", WS_CHILD|WS_VISIBLE|BS_CHECKBOX, CRect(182, 142, 182+35, 142+32), this, IDC_CHECK_SETTING_PLAYPROTECT);		//放音密码
	m_chbSettingSupperPassWord.Create(L"", WS_CHILD|WS_VISIBLE|BS_CHECKBOX, CRect(182, 193, 182+35, 193+32), this, IDC_CHECK_SETTING_ADNINPROTECT);		//超级密码
	...
	m_rdoAutoRecord.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(274, 98, 274+32, 98+34), this, IDC_RADIO_SETTING_RECORDAUTO);
	m_rdoAutoRecord.SetColor(RGB(0, 0, 0), RGB(237, 237, 237));//Data::g_allFramInRectBackRGB[Data::g_skinstyle]);
	m_rdoManulRecord.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(405, 97, 405+32, 97+34), this, IDC_RADIO_SETTING_RECORDMANUL);
...
*/
	m_recordMiddle.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(304, 251, 304+32, 251+34), this, IDC_RADIO_SETTING_RECORDMIDDLE);
	m_recordMiddle.SetColor(RGB(0, 0, 0), RGB(237, 237, 237));//Data::g_allFramInRectBackRGB[Data::g_skinstyle]);
	m_recordHight.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(428, 250, 428+32, 250+34), this, IDC_RADIO_SETTING_RECORDHIGHT);
