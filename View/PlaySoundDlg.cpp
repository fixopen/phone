...
namespace View {
    ...
    BOOL CPlaySoundDlg::OnInitDialog() 
    {
        ...
        m_sticNameNO.Create(str, WS_CHILD|WS_VISIBLE, CRect((48 )*X_XISHU, (70 )*Y_XISHU, (526 )*X_XISHU, (100 )*Y_XISHU), &m_MJPGList);
        m_sticNameNO.SetColor(RGB(0, 0, 0), RGB(203, 203, 203));//Data::g_partFrameInRectBackRGB[Data::g_skinstyle]);

        m_sticSoundName.Create(str, WS_CHILD|WS_VISIBLE, CRect((48 )*X_XISHU, (106 )*Y_XISHU, (280  -8)*X_XISHU, (136 )*Y_XISHU), &m_MJPGList);
        m_sticSoundName.SetColor(RGB(0, 0, 0), RGB(203, 203, 203));//Data::g_partFrameInRectBackRGB[Data::g_skinstyle]);

        m_sticSoundDuration.Create(str, WS_CHILD|WS_VISIBLE, CRect((280  - 8)*X_XISHU, (106 )*Y_XISHU, (526 )*X_XISHU, (136 )*Y_XISHU), &m_MJPGList);
        ...
        m_procbarSound.Create(WS_CHILD|WS_VISIBLE, CRect((55 )*X_XISHU, (153 )*Y_XISHU, (520 )*X_XISHU, (180 )*Y_XISHU), &m_MJPGList, IDC_PBAR_SOUNDDLG_PROCESS);
        ...
        str = strTemp.c_str();
        str = _T("");
        m_chkPlayContinue.Create(str, WS_CHILD|WS_VISIBLE|BS_CHECKBOX, CRect((48 )*X_XISHU, (216 )*Y_XISHU, (88 )*X_XISHU, (253 )*Y_XISHU), &m_MJPGList, IDC_CHECK_SOUNDDLG_PLAYCONTINUE);
