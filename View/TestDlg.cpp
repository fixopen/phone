...
DWORD CTestDlg::ThreadCallProc(LPVOID lParam) {
    ...
    while (pDlg->m_bFlagCall /* && nCount < 10000*/) {
        ...
        swprintf_s(buf, 64, L"Times of calling: %d", ++nCount);
...
//  [12/3/2008 wwf]
const char* pFamily[] = {
    "王", "李", "张", "刘", "陈", "杨", "黄", "赵", "周", "吴", "徐", "孙", "朱", "马", "胡", "郭", "林", "何", "高", "梁", "郑", "罗", "宋", "谢", "唐", "韩", "曹", "许", "邓", "萧", "冯", "曾", "程", "蔡", "彭", "潘", "袁", "于", "董", "余", "苏", "叶", "吕", "魏", "蒋", "田", "杜", "丁", "沈", "姜", "范", "江", "傅", "钟", "卢", "汪", "戴", "崔", "任", "陆", "廖", "姚", "方", "金", "邱", "夏", "谭", "韦", "车", "贾", "邹", "石", "熊", "孟", "秦", "阎", "薛", "侯", "雷", "白", "龙", "段", "郝", "孔", "邵", "史", "毛", "常", "万", "顾", "赖", "武", "康", "贺", "严", "尹", "钱", "施", "牛", "洪", "龚", "怯", "万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方", "赫连", "皇甫", "尉迟", "公羊", "澹台", "公冶", "宗政", "濮阳", "淳于", "单于", "太叔", "申屠", "公孙", "仲孙", "轩辕", "令狐", "钟离", "宇文", "长孙", "慕容", "鲜于", "闾丘", "司徒", "司空", "亓官", "司寇", "仉督", "子车", "颛孙", "端木", "巫马", "公西", "漆雕", "乐正", "壤驷", "公良", "拓拔", "夹谷", "宰父", "谷梁", "晋楚", "闫法", "汝鄢", "涂钦", "段干", "百里", "东郭", "南门", "呼延", "归海", "羊舌", "微生", "岳帅", "缑亢", "况后", "有琴", "梁丘", "左丘", "东门", "西门", "商牟", "佘佴", "伯赏", "南宫", "墨哈", "谯笪", "年爱", "阳佟"
};          //163

const char* pName[] = {
    "六", "伉", "光", "匡", "共", "各", "考", "交", "件", "价", "企", "伍", "伎", "仰", "吉", "圭", "曲", "机", "艮", "仲", "吉", "州", "朱", "兆", "决", "匠", "地", "旨", "朵", "吏", "列", "年", "劣", "同", "打", "汀", "至", "臼", "灯", "竹", "老", "舟", "伎", "吊", "吏", "圳", "的", "宅", "机", "老", "肉", "虫", "伊", "仰", "伍", "印", "因", "宇", "安", "屹", "有", "羊", "而", "耳", "衣", "亦", "吃", "夷", "奸", "聿", "丞", "企", "休", "任", "先", "全", "再", "冲", "刑", "向", "在", "夙", "如", "宅", "守", "字", "存", "寺", "式", "戌", "收", "早", "旭", "旬", "曲", "次", "此", "求", "系", "肉", "臣", "自", "舌", "血", "行", "圳", "西", "休", "交", "件", "企", "匠", "吉", "尖", "而", "至", "色", "伏", "后", "名", "回", "好", "妃", "帆", "灰", "牟", "百", "份", "米", "伐", "亥", "卉", "冰", "刑", "合", "向", "旭", "朴", "系", "行", "汜", "复", "克", "告", "改", "攻", "更", "杆", "谷", "况", "伽", "估", "君", "吴", "吸", "吾", "圻", "均", "坎", "研", "完", "局", "岐", "我", "扣", "杞", "江", "究", "见", "角", "言", "住", "占", "低", "佃", "况", "里", "冷", "伶", "利", "助", "努", "君", "吝", "昌", "壮", "妓", "妞", "局", "弄", "廷", "弟", "彤", "志", "托", "杖", "杜", "呆", "李", "江", "男", "究", "良", "见", "角", "具", "皂", "里", "舟", "佟", "你", "体", "足", "甸", "町", "豆", "吞", "玎", "位", "佐", "佘", "冶", "吾", "吟", "吴", "吻", "完", "尾", "巫", "役", "忘", "我", "修", "言", "邑", "酉", "吟", "吴", "研", "呆", "角", "七", "伸", "佐", "作", "些", "伽", "些", "初", "吹", "呈", "坐", "孝", "宋", "岐", "希", "岑", "床", "序", "巡", "形", "忍", "成", "杏", "材", "杉", "束", "村", "杞", "步", "汝", "汐", "池", "私", "秀", "赤", "足", "身", "车", "辰", "系", "占", "伺", "住", "余", "助", "劭", "劬", "邵", "吸", "坐", "壮", "妆", "局", "床", "志", "汕", "江", "灶", "见", "即", "却", "克", "早", "何", "布", "伯", "伴", "佛", "兵", "判", "别", "含", "坊", "坂", "吵", "宏", "旱", "每", "甫", "牡", "况", "免", "孚", "孝", "尾", "巫", "希", "庇", "形", "忙", "杏", "步", "汛", "贝", "儿", "庚", "快", "抗", "昆", "果", "空", "亟", "其", "具", "奇", "委", "季", "宜", "居"
};  //350
const char* pCompany[] = {
    "龙族鲜花店", "怡红快绿鲜花店", "送爽鲜花店", "阅色珠宝玉器", "童氏地缘珠宝", "宝之苑商贸有限公司", "靓伊爱尔工业饰品连锁(中国）总部", "颐和祥珠宝有限公司", "浙江温岭雪瑶珍珠养殖公司", "中鼎元珠宝有限公司", "聚天宝首饰行", "七色麻服装专卖店", "FUBU专卖店", "北京东圣高策商贸有限公司", "北京山之苑商贸有限公司", "天雅服装市场", "北京动物园天乐服装批发市场", "北京福昌隆服装店", "北京百衣百顺时装店", "北京瑞丽华服装店", "北京梅兰妮服装店", "品博苑", "丰泽园饭庄", "湘川鄂情", "嘉丰湘菜馆", "龙鼎湘江", "红色江山", "潭州酒楼", "湘鄂春", "洞庭楼"
};      //30

const char* pDepartment[] = {
    "董事长办公室", "总经理办公室", "人力资源部", "企管部", "技术部", "生产部", "销售部", "财务部", "后勤部", "基建设备部", "采购部"
};      //11

BOOL RandName(char chName[], int nBufSize) {
    if (!chName || nBufSize < 10) {
        return FALSE;
    }
    ...
    sprintf_s(chName, nBufSize, "%s%s", pFamily[nIndex1], pName[nIndex2]);

    if (nFlag) {
        int nIndex3 = rand() % 350;
        strcat_s(chName, nBufSize, pName[nIndex3]);
    }
...
BOOL RandPhone(char chPhone[12], int nBufSize) {
    ...
    if (nFlag) {
        ...
        sprintf_s(chPhone, 12, "13%05d", nNumber);

        nNumber = rand() % 10000;
        sprintf_s(chbuf, 6, "%04d", nNumber);
        strcat_s(chPhone, 12, chbuf);
    } else {
        char chbuf[6] = {
            0
        };
        int nNumber = rand() % 100000;
        sprintf_s(chPhone, 12, "15%05d", nNumber);
