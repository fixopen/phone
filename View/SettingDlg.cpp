...
/////////////////////////////////////////////////////////////////////////////
// CSettingDlg dialog
CString s_VerSionTitle = "6.34090421";
CString s_VerSion = "\
6.03090325\
1.修改了录音密码.\
6.00090319\
...
*/
	m_recordMiddle.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(295, 298, 295+32, 298+34), this, IDC_RADIO_SETTING_RECORDMIDDLE);
	m_recordMiddle.SetColor(RGB(0, 0, 0), RGB(237, 237, 237));//Data::g_allFramInRectBackRGB[Data::g_skinstyle]);
	m_recordHight.Create(str, WS_CHILD|WS_VISIBLE/*|BS_RADIOBUTTON*/, CRect(429, 298, 429+32, 298+34), this, IDC_RADIO_SETTING_RECORDHIGHT);
