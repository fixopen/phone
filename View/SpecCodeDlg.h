#if !defined(AFX_FASTDIALSDLG_H__6F1EB099_1F0C_487C_AAED_221F5FB6088B00__INCLUDED_)
#define AFX_FASTDIALSDLG_H__6F1EB099_1F0C_487C_AAED_221F5FB6088B00__INCLUDED_
...
class CSpecCodeDlg : public CCEDialog
{
// Construction
public:
	boost::shared_ptr<Data::Setting>  m_Data;
	void SetSpecCodeParam(	boost::shared_ptr<Data::Setting> data);
	CSpecCodeDlg(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CSpecCodeDlg)
