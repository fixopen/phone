...
namespace View {
    ...
    BOOL CSoundSearchDlg::OnInitDialog() 
    {
        ...
        */
        ...
        m_dtTo.Create(WS_VISIBLE|WS_CHILD|DTS_SHORTDATEFORMAT, CRect(360 , 122*Y_XISHU , (360 + 184)*X_XISHU , (122 + 32)*Y_XISHU ), &m_MJPGList, IDC_DATETIME_SOUNDSEARCH_TO, 28, CDateCtrl::modeDate);
        m_Font.CreateFont(
            28,                        // nHeight
            0,                         // nWidth
            0,                         // nEscapement
